    ...
    >
      ...
      {!preloading && (
        <motion.form
          ...
          className="relative z-10 mx-4 w-full max-w-lg space-y-6 rounded-3xl border border-white/10 bg-white/30 p-8 shadow-xl backdrop-blur transition-all duration-300 ease-in-out"
          ...
          noValidate
        >
          <h2 className="text-center text-3xl text-black/80">Iniciar Sesión</h2>
          {/* Campos de Email */}
          <div className="space-y-1">
            ...
            <div className="relative">
              <input
                ...
                autoFocus
                className={`input-glass w-full rounded-xl border border-black/10 bg-white/10 px-4 py-2 pr-10 text-base text-black outline-none transition-colors placeholder:text-black/50 focus:border-black/30 focus:ring-1 focus:ring-black/30 ${emailError ? "border-red-600 focus:ring-red-300" : ""}`}
              />
              <svg
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <input
                ...
                className={`input-glass w-full rounded-xl border border-black/10 bg-white/10 px-4 py-2 pr-10 text-base text-black outline-none transition-colors placeholder:text-black/50 focus:border-black/30 focus:ring-1 focus:ring-black/30 ${passwordError ? "border-red-600 focus:ring-red-300" : ""}`}
              />
              <button
