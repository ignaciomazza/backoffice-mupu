// src/components/templates/ConfirmationPreview.tsx
...
interface ConfirmationPreviewProps {
  confirmation: Confirmation & { logoBase64?: string };
  user: User;
}
        ...
        <div className="pb-24">
          ...
          <div className="px-10">
            ...
            <div className="mb-20">
              ...
              <div className="mb-10 space-y-1">
                ...
                <p className="">
                  Fecha de alta:{" "}
                  <span className="ml-1 font-light">
                    {formatDate(confirmation.issueDate)}
                  </span>
                </p>
                <p className="">
                  Fecha de vencimiento:{" "}
                  <span className="ml-1 font-light">
                    {formatDate(confirmation.expiryDate)}
                  </span>
                </p>
              </div>
              <p className="mb-5 text-xl font-semibold text-white">
              ...
              <p className="mb-10 whitespace-pre-wrap text-justify font-light">
                {renderRich(confirmation.services)}
              </p>
            </div>

            <div className="mb-20 space-y-3">
              <h3 className="text-xl font-semibold text-white">CONDICIONES</h3>
              <p className="whitespace-pre-wrap text-justify font-light text-white">
                * Reprogramaciones aéreas. La agencia no se responsabiliza por
                cualquier tipo de modificación y/o reprogramación de las
                compañías aéreas ya que estos cambios son decisiones que
                corresponden exclusivamente a las aerolíneas y/o aeropuertos.
                Tarifa R de Aerolíneas Argentinas: una vez emitido el vuelo
                permite 1(un) cambio sin costo siempre que se respeten la misma
                clase, escalas, ruta y temporada. Cambios posteriores aplica
                penalidad del 50% más diferencia de tarifa. No admite
                cancelación o devolución bajo ningún concepto.
              </p>
              <p className="whitespace-pre-wrap text-justify font-light text-white">
                * Modificaciones y alteraciones solicitadas por los pasajeros.
                Las modificaciones de los servicios quedan sujetas a la
                disponibilidad de los mismos y pueden sufrir ajustes de tarifas
                que deberán ser afrontadas por los pasajeros. El asesor no
                procederá al cambio de los servicios si no se ha acordado
                previamente con el pasajero.
              </p>
              <p className="whitespace-pre-wrap text-justify font-light text-white">
                * Cancelaciones solicitadas por los pasajeros. Solo se podrán
                efectuar hasta 30 días antes del viaje. Los servicios son no
                reembolsables. La devolución monetaria está sujeta a cada una de
                las políticas de los prestadores de los servicios. Los servicios
                aéreos no tienen devolución. Los servicios hoteleros en
                reiteradas ocasiones cobran penalidad por cancelación o pueden
                tener tarifas no reembolsables. Los reintegros se realizan
                dentro de 21 días hábiles.
              </p>
              <p className="whitespace-pre-wrap text-justify font-light text-white">
                * Limitaciones al derecho de permanencia. La agencia se reserva
                el derecho de prestar sus servicios de asesoramiento y
                acompañamiento en cualquier momento de la contratación si es que
                la conducta del pasajero o su modo de obrar atenta con la
                seguridad física y/o mental de cualquier integrante de la
                compañía.
              </p>
              <p className="whitespace-pre-wrap text-justify font-light text-white">
                * Datos de los pasajeros para la reserva. Los vendedores al
                momento de realizar la reserva del viaje solicitarán a los
                pasajeros foto del DNI o pasaporte, para destinos
                internacionales, de las personas que viajarán. Si el pasajero
                opta por no enviar las imágenes y prefiere enviar los datos por
                escrito la agencia no se responsabilizará si el pasajero comete
                errores en el envío de la información. Es responsabilidad del
                pasajero corroborar que sus datos personales estén correctos,
                así como el detalle de los servicios contratados, tanto en la
                confirmación de servicios enviada como en los
                documentos/vouchers de viaje.
              </p>
              <p className="whitespace-pre-wrap text-justify font-light text-white">
                * Una vez confirmada la hotelería escogida por el titular de la
                reserva se asume la conformidad de la misma. Dado por sentado
                así, que el servicio ha sido aceptado y verificado por la
                totalidad de las personas a viajar al destino al momento del
                pago. Para servicios internacionales las habitaciones triples no
                garantizan 3 camas, pudiendo ser dos camas queen o bien una cama
                matrimonial y una twin. Dependiendo del hotel queda a requerir
                catre y/o cama adicional.
              </p>
              <p className="whitespace-pre-wrap text-justify font-light text-white">
                * La realización del Check in y/o selección de asientos es pura
                y exclusiva responsabilidad del pasajero ya que es un trámite de
                índole personal. Los agentes de viaje de Mupu SRL realizamos en
                buena voluntad asesoramiento y brindamos asistencia en la
                gestión de dichos trámites para agilizar y hacer de su viaje uno
                más cómodo. No obstante, no es responsabilidad de la agencia ni
                de sus agentes. Asimismo, ni la agencia ni sus agentes de viaje
                pueden hacerse responsables por el mal funcionamiento de las
                páginas y/o canales de comunicación de las compañías aéreas ya
                que son plataformas que están por fuera de nuestro control.
              </p>
              <p className="whitespace-pre-wrap text-justify font-light text-white">
                * Asistencia al viajero. La comunicación con la asistencia al
                viajero debe ser personal de cada pasajero y/o familiar. Los
                agentes de viaje pueden asistir y asesorar al pasajero sobre
                cómo realizar la comunicación con la misma pero no pueden
                interferir ni ser canal de comunicación con la asistencia ya que
                es un trámite de índole personal. Asimismo, la agencia no se
                hace responsable de las devoluciones o reclamos que se realicen
                a las compañías de asistencia. Los agentes de viaje ofrecen el
                servicio de asistencia pero queda a cargo del cliente la lectura
                de sus cláusulas.
              </p>
            </div>
            ...
            <div className="mb-20">
              {confirmation.items.map((it, i) => (
                <div key={i} className="flex flex-col">
                  ...
                  <span className="font-bold">{it.concept}</span>
                </div>
              ))}
            </div>
            ...
            <p className="mb-20 whitespace-pre-wrap text-justify text-sm font-light text-white">
              Con la firma a continuación y/o pago de la reserva presto pleno
              conocimiento y total conformidad con las condiciones generales y
              servicios señaladas en este documento
            </p>

            <div className="mb-20 flex w-full flex-col items-end justify-center text-xs font-light">
              <p>
