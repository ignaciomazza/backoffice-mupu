    ...
    <Document>
      ...
      <Page size="A4" style={styles.firstPage}>
        <View style={styles.imageContainer}>
          <Image src={`/images/avion.jpg`} style={styles.regionImg} />
      ...
      <Page size="A4" style={styles.secondPage}>
        <View style={styles.content}>
          <View style={{ marginBottom: 24 }}>
            ...
            <Text style={{ marginBottom: 4 }}>
              <Text style={{ marginRight: 4 }}>Cliente: </Text>
              <Text style={{ fontWeight: "300" }}>{clientName}</Text>
            </Text>
            <Text style={{ marginBottom: 4 }}>
              <Text style={{ marginRight: 4 }}>Fecha de Emisión: </Text>
              <Text style={{ fontWeight: "300" }}>{fmtDate(issueDate)}</Text>
            </Text>
            <Text style={{ marginBottom: 4 }}>
          ...
          <View style={styles.section}>
            ...
            <Text style={{ fontWeight: "300", textAlign: "justify" }}>
              * Reprogramaciones aéreas. La agencia no se responsabiliza por
              cualquier tipo de modificación y/o reprogramación de las compañías
              aéreas ya que estos cambios son decisiones que corresponden
              exclusivamente a las aerolíneas y/o aeropuertos. Tarifa R de
              Aerolíneas Argentinas: una vez emitido el vuelo permite 1(un)
              cambio sin costo siempre que se respeten la misma clase, escalas,
              ruta y temporada. Cambios posteriores aplica penalidad del 50% más
              diferencia de tarifa. No admite cancelación o devolución bajo
              ningún concepto.
            </Text>
            <Text style={{ fontWeight: "300", textAlign: "justify" }}>
              * Modificaciones y alteraciones solicitadas por los pasajeros. Las
              modificaciones de los servicios quedan sujetas a la disponibilidad
              de los mismos y pueden sufrir ajustes de tarifas que deberán ser
              afrontadas por los pasajeros. El asesor no procederá al cambio de
              los servicios si no se ha acordado previamente con el pasajero.
            </Text>
            <Text style={{ fontWeight: "300", textAlign: "justify" }}>
              * Cancelaciones solicitadas por los pasajeros. Solo se podrán
              ...
              aéreos no tienen devolución. Los servicios hoteleros en reiteradas
              ocasiones cobran penalidad por cancelación o pueden tener tarifas
              no reembolsables. Los reintegros se realizan dentro de 21 días
              hábiles.
            </Text>
            <Text style={{ fontWeight: "300", textAlign: "justify" }}>
              * Limitaciones al derecho de permanencia. La agencia se reserva el
              derecho de prestar sus servicios de asesoramiento y acompañamiento
              en cualquier momento de la contratación si es que la conducta del
              pasajero o su modo de obrar atenta con la seguridad física y/o
              mental de cualquier integrante de la compañía.
            </Text>
            <Text style={{ fontWeight: "300", textAlign: "justify" }}>
              * Datos de los pasajeros para la reserva. Los vendedores al
              momento de realizar la reserva del viaje solicitarán a los
              pasajeros foto del DNI o pasaporte, para destinos internacionales,
              de las personas que viajarán. Si el pasajero opta por no enviar
              las imágenes y prefiere enviar los datos por escrito la agencia no
              se responsabilizará si el pasajero comete errores en el envío de
              la información. Es responsabilidad del pasajero corroborar que sus
              datos personales estén correctos, así como el detalle de los
              servicios contratados, tanto en la confirmación de servicios
              enviada como en los documentos/vouchers de viaje.
            </Text>
            <Text style={{ fontWeight: "300", textAlign: "justify" }}>
              * Una vez confirmada la hotelería escogida por el titular de la
              reserva se asume la conformidad de la misma. Dado por sentado así,
              que el servicio ha sido aceptado y verificado por la totalidad de
              las personas a viajar al destino al momento del pago. Para
              servicios internacionales las habitaciones triples no garantizan 3
              camas, pudiendo ser dos camas queen o bien una cama matrimonial y
              una twin. Dependiendo del hotel queda a requerir catre y/o cama
              adicional.
            </Text>
            <Text style={{ fontWeight: "300", textAlign: "justify" }}>
              * La realización del Check in y/o selección de asientos es pura y
              exclusiva responsabilidad del pasajero ya que es un trámite de
              índole personal. Los agentes de viaje de Mupu SRL realizamos en
              buena voluntad asesoramiento y brindamos asistencia en la gestión
              de dichos trámites para agilizar y hacer de su viaje uno más
              cómodo. No obstante, no es responsabilidad de la agencia ni de sus
              agentes. Asimismo, ni la agencia ni sus agentes de viaje pueden
              hacerse responsables por el mal funcionamiento de las páginas y/o
              canales de comunicación de las compañías aéreas ya que son
              plataformas que están por fuera de nuestro control.
            </Text>
            <Text style={{ fontWeight: "300", textAlign: "justify" }}>
              * Asistencia al viajero. La comunicación con la asistencia al
              viajero debe ser personal de cada pasajero y/o familiar. Los
              agentes de viaje pueden asistir y asesorar al pasajero sobre cómo
              realizar la comunicación con la misma pero no pueden interferir ni
              ser canal de comunicación con la asistencia ya que es un trámite
              de índole personal. Asimismo, la agencia no se hace responsable de
              las devoluciones o reclamos que se realicen a las compañías de
              asistencia. Los agentes de viaje ofrecen el servicio de asistencia
              pero queda a cargo del cliente la lectura de sus cláusulas.
            </Text>
          </View>
          <View style={styles.section}>
            {items.map((it, i) => (
              ...
              >
                ...
                <Text style={{ fontWeight: "bold" }}>{it.concept}</Text>
              </View>
            ))}
          </View>
          <View style={styles.section}>
