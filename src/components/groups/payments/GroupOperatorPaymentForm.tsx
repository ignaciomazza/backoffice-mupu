// src/components/groups/payments/GroupOperatorPaymentForm.tsx
"use client";
...
export default function GroupOperatorPaymentForm({
  ...
  const assertAccountMatchesCurrency = (): boolean => {
    for (const line of paymentLines) {
      ...
      const requiresAccountLine = !!requiresAccountMap.get(norm(line.payment_method));
      if (!requiresAccountLine) continue;
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-[11px] leading-relaxed text-slate-600 dark:text-slate-400 md:text-xs">
                  ...
                  <div className="space-y-3 md:col-span-2">
                        ...
                        >
                          <div className="mb-3 flex items-center justify-between">
                            ...
                            <button
                              ...
                              className="rounded-full border border-slate-300/80 bg-white/85 px-3 py-1 text-xs text-slate-700 transition-colors hover:bg-slate-100 dark:border-slate-600 dark:bg-slate-900/70 dark:text-slate-200 dark:hover:bg-slate-800/70"
                              title="Quitar línea"
                            >
                              Quitar
                            </button>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      <button
                        ...
                        className="rounded-full border border-slate-300/80 bg-white/85 px-4 py-2 text-xs text-slate-700 transition-colors hover:bg-slate-100 dark:border-slate-600 dark:bg-slate-900/70 dark:text-slate-200 dark:hover:bg-slate-800/70"
                      >
                        + Agregar línea
                      </button>
                  ...
                  >
                    {!operatorId || !currency ? (
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <button
                          type="button"
                          className="rounded-full border border-sky-300/80 bg-sky-100/80 px-3 py-1 text-sky-900 shadow-sm shadow-sky-100/60 dark:border-sky-700 dark:bg-sky-900/25 dark:text-sky-100"
                          disabled
                        >
                          <Spinner />
                        </button>
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <button
                          ...
                          className="rounded-full border border-sky-300/80 bg-sky-100/80 px-3 py-1 text-sky-900 shadow-sm shadow-sky-100/60 transition-colors hover:bg-sky-100 dark:border-sky-700 dark:bg-sky-900/25 dark:text-sky-100 dark:hover:bg-sky-900/35"
                        >
